...
The philosophy of this project is to keep the core simple and scalable by exposing low-level accessibility and composing functions, not by adding options.
